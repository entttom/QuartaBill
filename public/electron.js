...
function createWindow() {
  ...
  const template = [
    ...
    },
    {
      ...
      submenu: [
        {
          label: 'Über Rechnung Generator',
          click: () => {
            dialog.showMessageBox(mainWindow, {
              type: 'info',
              title: 'Über Rechnung Generator',
              message: 'Rechnung Generator v1.0.0',
              detail: 'Automatischer Rechnungsgenerator für Quartalsabrechnungen'
            });
          }
        }
      ]
